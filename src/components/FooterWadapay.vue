			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer_desc small_text">
          				<p class="animation" data-animation="fadeInUp" data-animation-delay="0.4s">Un token 100% impulsado por la comunidad con utilidad en la industria B2B. Creado por Wadaboo (plataforma B2B) para que funcione dentro y fuera como medio de pago entre empresas, envios internacionales, préstamos, etc.</p>
                    </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-auto res_sm_mt_20">
                    ...
                    <ul class="footer_link list_none">
                        ...
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.3s"><a href="https://charts.bogged.finance/?token=0xEE1e22DB567897bB401311B79030344602EABE47" target="_blank">Gráfico</a></li>
                	...
                	<div class="footer_bottom">
                    	<div class="row">
                        	<div class="col-md-12 text-center">
                              <p class="copyright">Copyright Wadapay; {{ new Date().getFullYear() }} Todos los derechos reservados.</p>
                            </div>
                        </div>
                    </div>
                </div>
