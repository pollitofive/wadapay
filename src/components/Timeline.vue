                    ...
                    <div class="timeline owl-carousel small_space">
                        ...
                        <div class="item">
                            ...
                            <div class="timeline_inner" style="color: #ffffff;font-size: 12px;">
                                ...
                                <li class="animation" data-animation="fadeInUp" data-animation-delay="0.4s">{{ $t("roadmap.item9.description1") }}</li>
                                <li class="animation" data-animation="fadeInUp" data-animation-delay="0.4s">{{ $t("roadmap.item9.description2") }}</li>
                            </div>
                            </div>
                        </div>
                        <div class="item">
