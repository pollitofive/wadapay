    ...
    *===================================*/
    $('.tk_countdown_time').each(function() {
        ...
        $(this).countdown(endTime, function(tm) {
            $(this).html(tm.strftime('<span class="counter_box"><span id="days" class="tk_counter days">%D </span><span class="tk_text"></span></span><span class="counter_box"><span id="hours" class="tk_counter hours">%H</span><span class="tk_text"></span></span><span class="counter_box"><span id="mins" class="tk_counter minutes">%M</span><span class="tk_text"></span></span><span class="counter_box"><span id="secs" class="tk_counter seconds">%S</span><span class="tk_text"></span></span>'));
        });
    });
